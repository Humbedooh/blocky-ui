...
var API, addRule, app, banRules, cog, deleteBan, deleteRule, deleteWhite, fetch, get, globArgs, isArray, loadDashboard, loadRules, manualBan, mk, oldPopup, popup, post, postJSON, renderDashboard, renderRules, renderWhitelist, ruleSpans, ruleTypes, set, showHide, sortTable, submitBan, submitRule, submitWhite, swi, txt, whiteList;
...
manualBan = function() {
  var btn, div, fd, fdd, fid, fih, form, main;
  main = get('bread');
  div = get('addrule');
  if (!div) {
    div = mk('div', {
