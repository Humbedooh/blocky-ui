...
var API, addRule, app, banRules, cog, deleteRule, fetch, get, globArgs, isArray, loadDashboard, loadRules, mk, oldPopup, popup, post, postJSON, renderDashboard, renderRules, ruleSpans, ruleTypes, set, showHide, sortTable, submitRule, swi, txt;
