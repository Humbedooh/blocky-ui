...
renderDashboard = function(json, edit) {
  ...
  app(main, h2);
  return showList(json.banlist, main);
};

showList = function(list, main) {
  var color, howMany, ip, ipname, l, len, pt, r, renewDate, since, tbl, tr, tracker;
    ...
    for (l = 0, len = list.length; l < len; l++) {
      ...
      if (ip.rid) {
        ...
        tr = new HTML('tr', {
          ...
          }, new HTML('kbd', {}, ipname)), new HTML('td', {
            style: {
              paddingRight: "20px"
            }
          }, renewDate), new HTML('td', {
            style: {
              paddingRight: "20px"
            }
