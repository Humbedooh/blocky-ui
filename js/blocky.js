...
var API, HTML, addRule, app, banRules, cog, deleteBan, deleteRule, deleteWhite, doQQ, fetch, findRule, get, globArgs, isArray, isHash, loadBread, loadDashboard, loadRules, loadTabs, manualBan, mk, oldPopup, popup, post, postJSON, renderDashboard, renderRules, renderWhitelist, ruleSpans, ruleTypes, set, showHide, showQQ, showRule, showTrack, sortTable, submitBan, submitRule, submitWhite, swi, trackBan, txt, whiteList;
