...
var API, app, cog, fetch, get, globArgs, isArray, loadDashboard, mk, oldPopup, popup, post, postJSON, renderDashboard, set, showHide, sortTable, swi, txt;

loadDashboard = function() {
  return fetch("./api/dashboard.lua", null, renderDashboard);
};
